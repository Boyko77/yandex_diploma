insert into "Couriers"(login, "passwordHash", "firstName", "createdAt", "updatedAt") values('bogdan', 'pa
sswordHash', 'bogdan', current_date, current_date);

insert into "Couriers"(login, "passwordHash", "firstName", "createdAt", "updatedAt") values('artem', 'pa
sswordHash', 'artem', current_date, current_date);

select * from "Couriers";

--orders for artem. 2 are in delivery
...
--orders for bogdan. 2 are in delivery
